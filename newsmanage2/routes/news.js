...
// 连接本地mongodb 服务器ip地址127.0.0.1 端口号:27017 连接的数据库名称 
mongoose.connect("mongodb://127.0.0.1:27017/zhangshuaiqi",function(err){
    if(!err){
        console.log("connected to Mongodb");//如果连接成功，则向控制台输出connected to Mongodb
    }else{
...
var NewsQueryModel = mongoose.model("DocNews");//用于查询的模型 
